...
module DocuSign_eSign
  class ApiClient
    ...
    def configure_jwt_authorization_flow(private_key_or_filename, oauth_base_path, client_id, user_id, expires_in)
      ...
      body_params = {}
      body_params.store('grant_type', 'urn:ietf:params:oauth:grant-type:jwt-bearer')
      body_params.store('assertion', token)

      response = self.call_api('POST', "https://" + oauth_base_path + "/oauth/token", { :header_params => header_params, :form_params => body_params, :return_type => "String" })
